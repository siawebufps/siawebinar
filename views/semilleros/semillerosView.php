<section class="slider-evento b-blanco">
	<article class="slider-evento__content">
		<div class="slider-evento__info">
			<p class="slider-evento__info--txt azul">Bienvenido</p>
			<h1 class="slider-evento__info--title azul">
				¿Quieres hacer parte de Siawebinar?
				Es sencillo, inscríbete 
...
<section class="user">
		...
		<div class="user__profile">
			<div class="user__info">
				...
				<div class="user__datos">
					...
					<a class="user__datos--a " href="http://siaweb.ufps.edu.co/">Siaweb.ufps.edu.co</a>
					<p class="user__datos--descripcion">
						Semillero de investigación de aplicaciones web.
					</p>
				</div>
			</div>
		...
		<div class="user__profile">
			<div class="user__info">
				...
				<div class="user__datos">
					...
					<a class="user__datos--a" href="http://silux.ufps.edu.co/">Silux.ufps.edu.co</a>
					<p class="user__datos--descripcion">
						Semillero de investigación de software libre y Linux de la UFPS.
					</p>
				</div>
			</div>
			<div class="user__posts">
		...
		<div class="user__profile">
			<div class="user__info">
				...
				<div class="user__datos">
					...
					<a class="user__datos--a " href="http://viral.ufps.edu.co/">Viral.ufps.edu.co</a>
					<p class="user__datos--descripcion">
						Semillero de Investigación de videojuegos Y realidad Virtual.
					</p>
				</div>
			</div>
			<div class="user__posts">
	...
	<a class="user__btn-vermas" href="listasemilleros.php">
		<p class="user__btn-vermas--txt">Ver más</p>
	</a>
</section>