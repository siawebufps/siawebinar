...
class EventoDAO
{
	...
	public function getDates($fecha1, $fecha2,$opcionFecha){
		$campotabla="";
		if($opcionfecha==0)$campotabla="fechainicio";
		if($opcionfecha==1)$campotabla="fechafin";
		try{
    		$result = array();
    		$sql="SELECT * FROM evento where '".$campotabla."' BETWEEN '".$fecha1."' AND '".$fecha2."'";
