 ...
 */
class Entidad extends \Entidad implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Entidad' . "\0" . 'id', '' . "\0" . 'Entidad' . "\0" . 'nombre', '' . "\0" . 'Entidad' . "\0" . 'tipo', '' . "\0" . 'Entidad' . "\0" . 'eventos', '' . "\0" . 'Entidad' . "\0" . 'ciudad'];
        }
    ...
    public function setEventos($eventos)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setEventos', [$eventos]);
